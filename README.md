...
- **Hardware:** i7/Ryzen 7 processor, 8–16 GB RAM, HD Webcam, NVIDIA GPU (optional)  
- **Software:** Windows 10 / Ubuntu 20.04+, Python 3.8+, TensorFlow, MediaPipe, OpenCV

---

## 🚀 Implementation Workflow
1. **Data Collection** – Captured gesture datasets using webcam.  
2. **Landmark Extraction** – Used MediaPipe Holistic to extract hand, face, and pose keypoints.  
3. **Data Preprocessing** – Normalized coordinates and organized sequences for training.  
4. **Model Building** – Trained an LSTM neural network for temporal gesture recognition.  
5. **Real-Time Translation** – Integrated trained model with OpenCV for live gesture recognition.  
6. **Sentence Formation** – Combined recognized words to form coherent sentences in real-time.  
...
| **Average Response Time** | ~70–80ms per gesture sequence |
...
## 🏆 Achievements
- 🧩 Successfully built a **real-time AI-based sign language translator**.  
- 💡 Presented the project at an **International Conference (ICAMA 2025)**.  
- ⚙️ Combined **Deep Learning + Computer Vision** for an end-to-end gesture recognition system.  
- 🌍 Contributed toward **inclusive AI technology** supporting accessibility and education.
...
## 📚 References
- [MediaPipe Holistic – Google AI Documentation](https://developers.google.com/mediapipe)  
...
> “Making communication accessible for everyone through the power of Artificial Intelligence.”

---

#### 👑 Developed by [**Mohd Azim I**]
🎓 Final Year B.Tech CSE | Hindustan Institute of Technology and Science | 2025    
🌍 Presented at *ICAMA 2025, Sri Sairam Engineering College, Chennai*
